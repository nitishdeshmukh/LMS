...
/**
 * CourseCompletionStatusChart - Displays course completion status with date filtering
 * @param {Object} props - Component properties
 * @param {Array} props.data - Course completion data array with category, value, and color
 * @param {number} props.height - Chart height in pixels
 * @param {number} props.innerRadiusPercent - Inner radius percentage for doughnut
 */
function CourseCompletionStatusChart({ data, height = 320, innerRadiusPercent = 60 }) {

...
/**
 * EnrollmentByCategoryChart - Displays enrollment distribution by category with date filtering
 * @param {Object} props - Component properties
 * @param {Array} props.data - Enrollment data array with category, value, and color
 * @param {number} props.height - Chart height in pixels
 * @param {number} props.innerRadiusPercent - Inner radius percentage for doughnut
 */
function EnrollmentByCategoryChart({ data, height = 320, innerRadiusPercent = 50 }) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-zinc-400">Distribution of students across course categories</p>
      </div>

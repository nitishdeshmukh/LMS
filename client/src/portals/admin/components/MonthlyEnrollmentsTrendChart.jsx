...
/**
 * MonthlyEnrollmentsTrendChart - Displays monthly enrollment trends with date filtering
 * @param {Object} props - Component properties
 * @param {Array} props.data - Monthly enrollment data array with category and value
 * @param {number} props.height - Chart height in pixels
 */
function MonthlyEnrollmentsTrendChart({ data, height = 320 }) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
      ...
      <div className="mb-4">
        <h2 className="text-xl font-semibold text-zinc-100 mb-1">Monthly Enrollments Trend</h2>
        <p className="text-sm text-zinc-400">New student enrollments over the past 6 months</p>
      </div>
      ...
      <div className="flex items-center gap-4 shrink-0">
        ...
        <div className="relative flex gap-2">
          <Input
            id="from-date-monthly-enrollment"
            value={fromValue}
      ...
      <ColumnChart data={data} height={height} />
    </div>
  );
}

export default MonthlyEnrollmentsTrendChart;

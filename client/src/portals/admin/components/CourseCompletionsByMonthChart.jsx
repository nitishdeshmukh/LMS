...
/**
 * CourseCompletionsByMonthChart - Displays course completions by month with date filtering
 * @param {Object} props - Component properties
 * @param {Array} props.data - Course completion data array with category and value
 * @param {number} props.height - Chart height in pixels
 */
function CourseCompletionsByMonthChart({ data, height = 320 }) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
      ...
      <div className="mb-4">
        <h2 className="text-xl font-semibold text-zinc-100 mb-1">Course Completions by Month</h2>
      ...
      <div className="flex items-center gap-4 shrink-0">
        ...
        <div className="relative flex gap-2">
          <Input
            id="from-date-course-completion"
            value={fromValue}
...
export default CourseCompletionsByMonthChart;

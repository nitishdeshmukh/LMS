...
/**
 * StudentGrowthChartWithFilter - Displays student growth over time with date filtering
 * @param {Object} props - Component properties
 * @param {Array} props.data - Student growth data array with date and value properties
 * @param {number} props.height - Chart height in pixels
 */
function StudentGrowthChartWithFilter({ data, height = 400 }) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
      ...
      <StudentGrowthChart data={data} height={height} />
    </div>
  );
}

export default StudentGrowthChartWithFilter;

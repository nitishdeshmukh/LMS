...
const DataBase = () => {
  ...
  const courseDetails = {
    ...
    subtitle: "A comprehensive 30-Day Roadmap mastering both SQL and NoSQL. From complex Joins to Aggregation Pipelines, become a Database expert.",
  ...
  const curriculum = [
    {
      ...
      practice: "The Bookstore DB: Create tables 'authors' and 'books'. Insert sample data. Write a JOIN query to display Book Titles alongside their Author Names."
    },
    {
      id: 2,
      ...
      practice: "Revenue Analysis: Add an 'orders' table. Use GROUP BY to calculate Total Revenue per Author. Use a CTE to filter and show only authors who earned > $100."
    },
    {
      id: 3,
      ...
      practice: "Rank The Sales: Write a query using RANK() to find the top 2 most expensive books within each genre. Create a View for this query for easy reuse."
    },
    {
      id: 4,
      ...
      practice: "NoSQL Bookstore: Create a 'Library' database in MongoDB. Insert book documents that utilize Embedded Documents for 'author' details and Arrays for 'tags'."
    },
    {
      id: 5,
      ...
      practice: "Inventory Report: Use the Aggregation Pipeline to calculate the total stock value per category from an 'inventory' collection. Sort results by highest value."
    },
    {
      id: 6,
      ...
      practice: "Schema Architect: Design the schema for a 'Social Media App' (Users, Posts, Comments) for both a SQL DB (relational) and MongoDB (document-based). Compare the structures."
    },
    {
      id: 7,
      ...
      practice: "Slow Query Fix: Insert 10,000 dummy records. Run a search query and measure time. Create an Index on the search field and measure the performance improvement."
    },
    {
      id: 8,
      ...
      practice: "Final Deliverable: Build the complete backend database for an E-commerce Platform. Implement Tables/Collections for Users, Products, Orders, and Reviews. Include detailed documentation of your schema."
    }
  ];

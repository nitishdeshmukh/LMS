...
const Fullstack = () => {
  ...
  const courseDetails = {
    ...
    subtitle: "A highly structured, intensive 30-Day MERN Stack Roadmap. Build real-world projects, master the stack, and get career-ready.",
  ...
  const curriculum = [
    { 
      ...
      practice: "Create a Registration Form: Build a static HTML page with a signup form containing Name, Email, Password, and a 'Role' dropdown. Use semantic tags (<header>, <footer>, <main>). Push this code to a GitHub repository."
    },
    { 
      id: 2, 
      ...
      practice: "Responsive Navbar: Create a navigation bar that displays links horizontally on a desktop but collapses into a 'Hamburger Menu' icon on mobile screens using CSS Media Queries."
    },
    { 
      id: 3, 
      ...
      practice: "Pricing Card Component: Re-create a modern 'Subscription Pricing Card' (e.g., Basic, Pro, Enterprise) using only Tailwind utility classes."
    },
    { 
      id: 4, 
      ...
      practice: "Interactive Calculator: Build a calculator where users can click buttons to perform addition, subtraction, multiplication, and division. The result must display on the screen using DOM manipulation."
    },
    { 
      id: 5, 
      ...
      practice: "Weather App (Fetch API): Build an app where a user types a city name, and you use fetch() to call a public Weather API (like OpenWeatherMap) to display the current temperature."
    },
    { 
      id: 6, 
      ...
      practice: "Todo App: Create a React app where users can add tasks to a list, check them off (line-through style), and delete them."
    },
    { 
      id: 7, 
      ...
      practice: "Movie Search App (Multi-page): Create an app with two pages: Home (search movies) and Details (click a movie to see description). Use React Router to navigate."
    },
    { 
      id: 8, 
      ...
      practice: "Backend Setup: Create an Express server with endpoints to GET a list of products and POST a new product. Test it using Postman or Thunder Client."
    },
    { 
      id: 9, 
      ...
      practice: "Full Stack Integration: Connect your React 'Todo App' (from Module 6) to a MongoDB database. Ensure that when you refresh the page, the Todos remain (data persistence)."
    },
    { 
      id: 10, 
      ...
      practice: "Final Deliverable: Choose one project (Student Management, Blog, E-commerce, Job Board, etc.). Build Frontend + Backend + DB. Deploy it and submit the Live Link + GitHub Repo."
    }
  ];
                ...
                <div className="lg:col-span-1 relative">
                    <div className="sticky top-24 bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/10">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-green-400 font-bold  mb-6">Pay just 10% of the course to Start Learning</p>

...
const UX = () => {
    ...
    const courseDetails = {
        ...
        subtitle: "A comprehensive 30-Day Roadmap. Master Design Thinking, Figma, Wireframing, and Prototyping to build user-centric digital products.",
    ...
    const curriculum = [
        {
            ...
            practice: "Persona Creation: Interview a friend about a daily habit (e.g., hydration). Create a User Persona PDF (Name, Age, Frustrations, Goals) based on that interview."
        },
        {
            id: 2,
            ...
            practice: "Crazy 8s: Fold a paper into 8 sections. Spend 8 minutes sketching 8 different layout ideas for a 'Mobile Login Screen'. Pick the best one and refine it."
        },
        {
            id: 3,
            ...
            practice: "Moodboard & Style Guide: Create a one-page Style Guide in Figma including Primary/Secondary Colors, Typography Scale, and Button Styles (Default, Hover, Disabled)."
        },
        {
            id: 4,
            ...
            practice: "Responsive Card: Design a 'Product Card' (Image, Title, Price, Button) using Auto Layout. Duplicate it 3 times and ensure updates to the Main Component reflect on all instances."
        },
        {
            id: 5,
            ...
            practice: "Interactive Prototype: Connect 3 screens (Login -> Home -> Settings). Use 'Smart Animate' to create a smooth transition when opening a menu or clicking a button."
        },
        {
            id: 6,
            ...
            practice: "Final Deliverable: Complete a full project (Food Delivery, Pet Adoption, etc.). Create a Case Study PDF covering Research, Sketches, and Hi-Fi Screens. Publish to Behance."
        }
    ];
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <div className="bg-blue-900/20 border border-blue-500/30 p-6 rounded-2xl">
                                ...
                                <p className="text-zinc-300 leading-relaxed">
                                    You only pay <strong>10% ({courseDetails.price})</strong> now to enroll and start the internship. The course content itself is a curated roadmap of high-quality, freely available resources. We do not charge for the content.
                                    <br /><br />

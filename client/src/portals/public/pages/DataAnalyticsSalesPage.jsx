...
const DataAnalytics = () => {
    ...
    const courseDetails = {
        ...
        subtitle: "A comprehensive 30-Day Roadmap. Master Excel, SQL, Power BI, and Python to transform raw data into actionable business insights.",
    ...
    const curriculum = [
        {
            ...
            practice: "Sales Dashboard: Clean a sample sales dataset. Create a Dashboard with 3 Pivot Charts (Region, Products, Trend) controlled by a 'Year' Slicer."
        },
        {
            id: 2,
            ...
            practice: "Statistical Summary: Calculate Mean, Median, and Std Dev for a revenue column. Identify outliers using the Z-Score method (> 3 standard deviations)."
        },
        {
            id: 3,
            ...
            practice: "The 3-Table Join: Write a query joining Customers, Orders, and OrderDetails tables to calculate the Total Revenue generated by each Customer."
        },
        {
            id: 4,
            ...
            practice: "Ranking Analysis: Write a SQL query using RANK() OVER (PARTITION BY ...) to identify the top 2 highest-paid employees within each department."
        },
        {
            id: 5,
            ...
            practice: "Interactive Report: Import SQL results into Power BI. Create Measures for Total Sales and YoY Growth. Build a dashboard with a Map, Bar Chart, and Cards."
        },
        {
            id: 6,
            ...
            practice: "Titanic EDA: Load the Titanic dataset using Pandas. Generate descriptive statistics and create a Bar Plot showing survival rates by Class and Gender."
        },
        {
            id: 7,
            ...
            practice: "Final Deliverable: Build a complete project (e.g., E-Commerce Sales Analysis, HR Attrition Dashboard). Submit GitHub Repo and a Portfolio Link."
        }
    ];
